  ...
  return (
    <button
      ...
      className={`
        ...
        rounded-[10px] border-[1.4px] px-[18px]
        ${buttonStyle}
        typo-navbar-button
    ...
    >
      <span
        className={`
          flex h-[13px] w-[13px] shrink-0 items-center justify-center
          rounded-full border-[1.2px]
          ${iconStyle}
        `}
      >
        {selected && (
      ...
      <span className="ml-[21px] truncate">{label}</span>
